...
LV_FONT_DECLARE(Ubuntu_48px);
    ...
    const lv_font_t *mainbar_font = &lv_font_montserrat_22;
    const lv_font_t *app_font = &lv_font_montserrat_22;
    const lv_font_t *setup_font = &lv_font_montserrat_22;
    const lv_font_t *setup_header_font = &lv_font_montserrat_32;
    const lv_font_t *app_icon_label_font = &lv_font_montserrat_22;
    const lv_font_t *system_icon_label_font = &lv_font_montserrat_22;
#elif defined( MID_THEME )
    const lv_font_t *mainbar_font = &lv_font_montserrat_14;
    const lv_font_t *app_font = &lv_font_montserrat_14;
    const lv_font_t *setup_font = &lv_font_montserrat_14;
    const lv_font_t *setup_header_font = &lv_font_montserrat_14;
    const lv_font_t *app_icon_label_font = &lv_font_montserrat_14;
    const lv_font_t *system_icon_label_font = &lv_font_montserrat_14;
#else
    const lv_font_t *mainbar_font = &lv_font_montserrat_14;
    const lv_font_t *app_font = &lv_font_montserrat_14;
    const lv_font_t *setup_font = &lv_font_montserrat_14;
...
void widget_style_theme_set( int theme ) {
    switch( theme ) {
        case( 0 ):      /** background **/
                        ...
                        /** maibbar colors **/
                        lv_style_set_bg_color( &mainbar_style, lv_color_white() );
                        lv_style_set_text_color( &mainbar_style, lv_color_black() );
                        lv_style_set_text_font( &mainbar_style, mainbar_font );
                        /** mainbar dropdown colors **/
                        lv_style_set_bg_color( &mainbar_dropdown_style, lv_color_white() );
                        lv_style_set_bg_opa( &mainbar_dropdown_style, LV_OPA_100);
                        lv_style_set_border_width( &mainbar_dropdown_style, 2 );
                        lv_style_set_text_font( &mainbar_dropdown_style, mainbar_font );
                        lv_style_set_text_color( &mainbar_dropdown_style, lv_color_black() );
                        /** app colors **/
                        lv_style_set_bg_color( &app_style, lv_color_white() );
                        lv_style_set_text_color( &app_style, lv_color_black() );
                        lv_style_set_text_font( &app_style, app_font );
                        /** app ops style color **/
                        lv_style_set_bg_color( &app_opa_style, lv_color_white() );
                        lv_style_set_text_font( &app_opa_style, app_font );
                        /** app dropdown colors **/
                        lv_style_set_bg_color( &app_dropdown_style, lv_color_white() );
                        lv_style_set_bg_opa( &app_dropdown_style, LV_OPA_100);
                        lv_style_set_border_width( &app_dropdown_style, 1 );
                        lv_style_set_text_font( &app_dropdown_style, app_font );
                        lv_style_set_text_color( &app_dropdown_style, lv_color_black() );
                        /** setup colors **/
                        lv_style_set_bg_color( &setup_tile_style, lv_color_white() );
                        lv_style_set_text_color( &setup_tile_style, lv_color_black() );
                        lv_style_set_img_recolor( &setup_tile_style, lv_color_black() );
                        lv_style_set_text_font( &setup_tile_style, setup_font );
                        /** setup dropdown style **/
                        lv_style_set_bg_color( &setup_dropdown_style, lv_color_white() );
                        lv_style_set_bg_opa( &setup_dropdown_style, LV_OPA_100);
                        lv_style_set_border_width( &setup_dropdown_style, 2 );
                        lv_style_set_border_color( &setup_dropdown_style, lv_color_black() );
                        lv_style_set_text_color( &setup_dropdown_style, lv_color_black() );
                        /** setup header style **/
                        lv_style_set_bg_color( &setup_header_tile_style, lv_color_white() );
                        lv_style_set_text_color( &setup_header_tile_style, lv_color_black());
                        lv_style_set_text_font( &setup_header_tile_style, setup_header_font );
                        /** system/app icon/label style **/
                        lv_style_set_img_recolor( &system_icon_style, lv_color_black() );
                        lv_style_set_text_color( &system_icon_label_style, lv_color_black() );
                        lv_style_set_text_font( &system_icon_label_style, system_icon_label_font);
                        lv_style_set_bg_opa( &app_icon_style, LV_OPA_20 );
                        lv_style_set_text_color( &app_icon_label_style, lv_color_black() );
                        lv_style_set_text_font( &app_icon_label_style, app_icon_label_font );
                        /** button/switch/slider  style **/
                        lv_style_set_radius( &button_style, 0 );
                        lv_style_set_border_color( &button_style, lv_color_black() );
                        lv_style_set_bg_color( &switch_style, lv_color_black() );
                        lv_style_set_bg_color( &slider_style, lv_color_black() );
        ...
        case( 1 ):      /** background **/
                        ...
                        /** maibbar colors **/
                        lv_style_set_bg_color( &mainbar_style, lv_color_black() );
                        ...
                        lv_style_set_text_color( &app_style, lv_color_white() );
                        lv_style_set_text_font( &app_style, app_font );
                        /** app ops style color **/
                        lv_style_set_bg_color( &app_opa_style, lv_color_white() );
                        lv_style_set_text_font( &app_opa_style, app_font );
                        ...
                        lv_style_set_text_color( &app_dropdown_style, lv_color_black() );
                        /** setup colors **/
                        lv_style_set_bg_color( &setup_tile_style, lv_color_black() );
                        ...
                        lv_style_set_text_color( &setup_dropdown_style, lv_color_black() );
                        /** setup header style **/
                        lv_style_set_bg_color( &setup_header_tile_style, lv_color_black() );
                        lv_style_set_text_color( &setup_header_tile_style, lv_color_white());
                        lv_style_set_text_font( &setup_header_tile_style, setup_header_font );
                        /** system/app icon/label style **/
                        lv_style_set_img_recolor( &system_icon_style, lv_color_white() );
                        lv_style_set_text_color( &system_icon_label_style, lv_color_white() );
                        lv_style_set_text_font( &system_icon_label_style, system_icon_label_font);
                        lv_style_set_bg_opa( &app_icon_style, LV_OPA_20 );
                        lv_style_set_text_color( &app_icon_label_style, lv_color_white() );
                        lv_style_set_text_font( &app_icon_label_style, app_icon_label_font );
                        /** button/switch/slider  style **/
                        lv_style_set_radius( &button_style, 0 );
                        ...
                        lv_style_set_bg_color( &slider_style, lv_palette_main(LV_PALETTE_GREY) );
                        /** trigger style change event **/
                        styles_send_event_cb( STYLE_CHANGE, (void*)NULL );
                        styles_send_event_cb( STYLE_DARKMODE, (void*)NULL );
                        break;
        case( 3 ):      lv_style_set_bg_color( &background_style, lv_color_black() );
                        /** maibbar colors **/
                        lv_style_set_bg_color( &mainbar_style, lv_color_white() );
                        lv_style_set_text_color( &mainbar_style, lv_color_black() );
                        lv_style_set_text_font( &mainbar_style, mainbar_font );
                        ...
                        lv_style_set_border_color( &setup_dropdown_style, lv_color_make( 0xa0, 0xa0, 0xa0 ) );
                        lv_style_set_text_color( &setup_dropdown_style, lv_color_black() );
                        /** setup header style **/
                        ...
                        lv_style_set_border_color( &button_style, lv_color_black() );
                        lv_style_set_bg_color( &switch_style, lv_palette_main(LV_PALETTE_GREEN) );
                        lv_style_set_bg_color( &slider_style, lv_palette_main(LV_PALETTE_GREEN) );

                        styles_send_event_cb( STYLE_CHANGE, (void*)NULL );
                        styles_send_event_cb( STYLE_DARKMODE, (void*)NULL );
                        break;
        default:        lv_style_set_bg_color( &background_style, lv_color_black() );
                        /** maibbar colors **/
                        lv_style_set_bg_color( &mainbar_style, lv_color_black() );
                        lv_style_set_text_color( &mainbar_style, lv_color_white() );
                        lv_style_set_text_font( &mainbar_style, mainbar_font );
                        ...
                        lv_style_set_border_width( &mainbar_dropdown_style, 0 );
                        lv_style_set_text_font( &mainbar_dropdown_style, mainbar_font );
                        lv_style_set_text_color( &mainbar_dropdown_style, lv_color_white() );
                        /** app colors **/                        
                        lv_style_set_bg_color( &app_style, lv_color_black() );
                        lv_style_set_text_color( &app_style, lv_color_white() );
                        lv_style_set_text_font( &app_style, app_font );
                        ...
                        lv_style_set_border_width( &app_dropdown_style, 0 );
                        lv_style_set_text_font( &app_dropdown_style, app_font );
                        lv_style_set_text_color( &app_dropdown_style, lv_color_white() );
                        /** setup colors **/
                        lv_style_set_bg_color( &setup_tile_style, lv_palette_main(LV_PALETTE_GREY) );
                        lv_style_set_text_color( &setup_tile_style, lv_color_white() );
                        lv_style_set_img_recolor( &setup_tile_style, lv_color_white() );
                        ...
                        lv_style_set_border_width( &setup_dropdown_style, 0 );
                        lv_style_set_border_color( &setup_dropdown_style, lv_color_make( 0xa0, 0xa0, 0xa0 ) );
                        lv_style_set_text_color( &setup_dropdown_style, lv_color_white() );
                        /** setup header style **/
                        lv_style_set_bg_color( &setup_header_tile_style, lv_palette_main(LV_PALETTE_GREY) );
                        lv_style_set_text_color( &setup_header_tile_style, lv_color_white() );
                        lv_style_set_text_font( &setup_header_tile_style, setup_header_font );
...
static void define_styles(){
    ...
    lv_style_set_radius( &mainbar_style, 0 );
    lv_style_set_bg_color( &mainbar_style, lv_color_black() );
    lv_style_set_bg_opa( &mainbar_style, LV_OPA_0 );
    lv_style_set_border_width( &mainbar_style, 0 );
    lv_style_set_img_recolor( &mainbar_style, lv_color_white() );
    lv_style_set_text_font( &mainbar_style, mainbar_font );
    lv_style_set_text_color( &mainbar_style, lv_color_white() );
    ...
    lv_style_set_bg_opa( &mainbar_dropdown_style, LV_OPA_100);
    lv_style_set_border_width( &mainbar_dropdown_style, 0 );
    lv_style_set_border_color( &mainbar_dropdown_style, lv_color_make( 0xa0, 0xa0, 0xa0 ) );
    lv_style_set_text_font( &mainbar_dropdown_style, mainbar_font );
    lv_style_set_text_color( &mainbar_dropdown_style, lv_color_white() );
    /**
     * app theme
    ...
    lv_style_set_radius( &app_style, 0 );
    lv_style_set_bg_color( &app_style, lv_color_black() );
    lv_style_set_bg_opa( &app_style, LV_OPA_0 );
    lv_style_set_border_width( &app_style, 0 );
    lv_style_set_text_color( &app_style, lv_color_white() );
    lv_style_set_img_recolor( &app_style, lv_color_white() );
    lv_style_set_text_font( &app_style, app_font );
    /* app opa style */
    ...
    lv_style_set_bg_opa( &app_dropdown_style, LV_OPA_100);
    lv_style_set_border_width( &app_dropdown_style, 0 );
    lv_style_set_border_color( &app_dropdown_style, lv_color_make( 0xa0, 0xa0, 0xa0 ) );
    lv_style_set_text_font( &app_dropdown_style, app_font );
    lv_style_set_text_color( &app_style, lv_color_white() );
    /**
     * setup theme
    ...
    lv_style_set_border_color( &setup_dropdown_style, lv_color_make( 0xa0, 0xa0, 0xa0 ) );
    lv_style_set_text_color( &setup_dropdown_style, lv_color_white() );
    lv_style_set_text_font( &setup_dropdown_style, setup_font );
    /**
    ...
    lv_style_set_bg_opa( &app_icon_style, LV_OPA_40 );
    lv_style_set_border_width( &app_icon_style, 0 );
    /**
    ...
    lv_style_set_text_line_space(&roller_bg_style, ROLLER_TEXT_SPACE);
    lv_style_init( &roller_part_selected_style );
    /**
     * general arc style
     */
    lv_style_init( &arc_bg_style );
    lv_style_set_bg_opa( &arc_bg_style, LV_OPA_TRANSP );
    lv_style_set_border_width( &arc_bg_style, 0 );
