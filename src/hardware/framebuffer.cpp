...
static lv_color_t *framebuffer_1 = NULL;                                     /** @brief pointer to a full size framebuffer */
static lv_color_t *framebuffer_2 = NULL;                                     /** @brief pointer to a full size framebuffer */
