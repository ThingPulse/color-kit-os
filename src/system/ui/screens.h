...
extern "C" {
    ...
    lv_obj_t *weather_label_name_day_0;
    lv_obj_t *weather_label_name_day_1;
    lv_obj_t *weather_label_name_day_2;
    lv_obj_t *weather_label_name_day_3;
    lv_obj_t *weather_label_temp_day_0;
    lv_obj_t *weather_label_temp_day_1;
    lv_obj_t *weather_label_temp_day_2;
    lv_obj_t *weather_label_temp_day_3;
    lv_obj_t *weather_image_day_0;
    lv_obj_t *weather_image_day_1;
    lv_obj_t *weather_image_day_2;
    lv_obj_t *weather_image_day_3;
